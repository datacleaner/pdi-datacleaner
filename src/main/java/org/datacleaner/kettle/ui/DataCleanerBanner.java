...
public class DataCleanerBanner extends Composite {
    ...
    public DataCleanerBanner(Composite parent) {
        ...
        // left part
        {
            ...
            leftComposite.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1));
            ...
            resources.add(font);
            label.setFont(font);
            ImageData imageData = new ImageData(getClass().getResourceAsStream("banner-left.png"));
            ...
            Cursor cursor = new Cursor(leftComposite.getDisplay(), SWT.CURSOR_HAND);
        ...
        // background part
        {
            ...
            resources.add(font);
            label.setFont(font);
            ImageData imageData = new ImageData(getClass().getResourceAsStream("banner-bg.png")).scaledTo(2000, HEIGHT);
            Image image = new Image(getShell().getDisplay(), imageData);
            resources.add(image);
            label.setBackground(image);
